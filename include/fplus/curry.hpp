...
{ \
    return [](const auto& p1) \
    { \
        return fplus::fplus_curry_define_fn_0_name(p1); \
    }; \
}
...
{ \
    ...
    { \
        return fplus::fplus_curry_define_fn_1_name(p1, fplus_curry_p2); \
    }; \
}
...
{ \
    ...
    { \
        ...
        { \
            return fplus::fplus_curry_define_fn_2_name(p1, fplus_curry_p2, fplus_curry_p3); \
        }; \
    }; \
}
...
{ \
    ...
    { \
        ...
        { \
            ...
            { \
                return fplus::fplus_curry_define_fn_3_name(p1, fplus_curry_p2, fplus_curry_p3, fplus_curry_p4); \
            }; \
        }; \
    }; \
}
...
return [p1](const auto& fplus_curry_p2) \
    { \
        ...
        { \
            return [p1, fplus_curry_p2, fplus_curry_p3](const auto& fplus_curry_p4) \
            { \
                return [p1, fplus_curry_p2, fplus_curry_p3, fplus_curry_p4](const auto& fplus_curry_p5) \
                { \
                    return fplus::fplus_curry_define_fn_4_name(p1, fplus_curry_p2, fplus_curry_p3, fplus_curry_p4, fplus_curry_p5); \
                }; \
            }; \
        }; \
    }; \
