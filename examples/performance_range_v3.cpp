...
int main()
{
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        std::chrono::duration<double> elapsed_s_fplus = endTimeFPlus - startTimeFPlus;
        ...
        const auto result_range_v3 = accumulate(
            view::ints(0)
                | view::take(15000000)
        ...
        std::chrono::duration<double> elapsed_s_rangev3 = endTimeRangev3 - startTimeRangev3;
