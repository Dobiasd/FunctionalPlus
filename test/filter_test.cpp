...
TEST_F(filter_test, keep_by_idx)
{
...
TEST_F(filter_test, drop_by_idx)
{
    const std::vector<int> v = { 11, 17, 3, 8, 49, 6 };
...
TEST_F(filter_test, trim_left_by)
{
...
TEST_F(filter_test, trim_token_left)
{
...
TEST_F(filter_test, trim_right_by)
{
    const std::vector<int> v = { 0, 2, 4, 5, 6, 7, 8, 6, 4 };
...
TEST_F(filter_test, trim_token_right)
{
